              ...
              <Card.Body>
                <Form>
                  <Form.Group>
                    ...
                    <Form.Control name="text" as="textarea" rows="3" onChange={(e) => this.handleChange(e)} />
                  </Form.Group>
                  <Button
                    name="textButton"
                    size="sm"
              ...
              <Card.Body>
                <Form>
                  <Form.Group>
                    ...
                    <Form.Control name="medNameId" as="select" onChange={(e) => this.handleChange(e)} >
                  ...
                  <Form.Group>
                    ...
                    <Form.Control name="medAmountId" as="select" onChange={(e) => this.handleChange(e)} >
                      <option value="0">---</option>
                  ...
                  <Form.Group>
                    ...
                    <Form.Control name="time" type="time" value={this.state.time} onChange={(e) => this.handleChange(e)} />
                  </Form.Group>
                  <Button
                    name="medButton"
                    size="sm"
      ...
      Create Drink Entry
              ...
              <Card.Body>
                <Form>
                  <Form.Group>
                    ...
                    <Form.Control name="drinkTypeId" as="select" onChange={(e) => this.handleChange(e)} >
                      <option value="0">---</option>
        {this.props.drinkOpts.types.map((opts) =>
            <option key={opts.id} value={opts.id}>{opts.name + ' (' + opts.tags.join(', ') + ')' }</option>
                  ...
                  <Form.Group>
                    <Form.Label>Amount</Form.Label>
                    <Form.Control name="drinkAmountId" as="select" onChange={(e) => this.handleChange(e)} >
                      <option value="0">---</option>
...
export default connect(mapStateToProps, { getDay, createText, createPhoto, createMedication, createDrink, getMedicationOpts, getDrinkOpts })(Day);
